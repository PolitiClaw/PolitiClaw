...
- `packages/politiclaw-plugin/src/storage/migrations/0014_action_moments.sql`
- `packages/politiclaw-plugin/src/storage/migrations/0015_preferences_action_prompting.sql`
...
, monitoring_cadence TEXT NOT NULL DEFAULT 'election_proximity'
  CHECK (monitoring_cadence IN ('off','election_proximity','weekly','both')), action_prompting TEXT NOT NULL DEFAULT 'on'
