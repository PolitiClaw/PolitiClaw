...
/**
 * Render a scoring result as text. Enforces two docs/risks.md rules:
 *   §1: confidence < 0.4 renders as "insufficient data" (raw numbers are
 *       kept in `details` for audit but hidden from prose).
 *   §1 disclaimer: every position-adjacent output includes
 *       ALIGNMENT_DISCLAIMER verbatim.
 */
